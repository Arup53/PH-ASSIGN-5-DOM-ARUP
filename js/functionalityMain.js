...
card1btn.addEventListener("click", function () {
  ...
  if (
    isNaN(card1Input) ||
    parseFloat(card1Input) > userBalanceValue ||
    !card1Input ||
    parseFloat(card1Input) < 0 ||
    parseFloat(card1Input) === 0
  ) {
    alert("invalid input");
    return;
...
card2Input.addEventListener("click", function () {
  ...
  if (
    ...
    parseFloat(card2Inputvalue) > userBalanceValue ||
    !card2Inputvalue ||
    parseFloat(card2Inputvalue) < 0 ||
    parseFloat(card2Inputvalue) === 0
  ) {
    alert("invalid input");
    return;
...
card3Input.addEventListener("click", function () {
  ...
  if (
    ...
    parseFloat(card3Inputvalue) > userBalanceValue ||
    !card3Inputvalue ||
    parseFloat(card3Inputvalue) < 0 ||
    parseFloat(card3Inputvalue) === 0
  ) {
    alert("invalid input");
    return;
